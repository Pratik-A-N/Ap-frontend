...
export default function Contact() {
  ...
  return (
    <div className="fluid-container">
        ...
        <div className="row disply-flex justify-content-center">
          ...
          <div className="col-lg-5 mt-5">
            <div className="row display-flex align-items-center cd">
            <img src={visit} alt="" srcset="" className='writ' /> <h3 style={{display:"contents"}} ><b>VISIT US!</b></h3> 
            </div>
            <div className="row pb-5 cc">
              <div className="col-lg-2 ">

              </div>
              <div className="col-lg-10 w-50 cc">
                <h4>Abhyuday Office Student Activity Center IIT Bombay - 400076</h4>

              </div>
            </div>
            <div className="row display-flex align-items-center cd">
            <img src={call} alt="" srcset="" className='writ' /> <h3 style={{display:"contents"}} ><b>GIVE US A CALL!</b></h3> 
            </div>
            <div className="row pb-5 cc">
              <div className="col-lg-2 ">
