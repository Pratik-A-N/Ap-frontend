...
export default function Mentorship() {
  return (
    <div className="fluid-container">
        ...
        <div className="row display-flex justify-content-center">
        <div className="col-lg-9 col-sm-12 px-5 pt-5">
        ...
        {/* <img src={mentor} alt="" srcset="" id='mentorbg'/> */}
          ...
          <div className="row display-flex justify-content-center b">
                  <div className="col-lg-3 a"><Link className="bt" to="/mentorreg">Register Now</Link></div>
          </div>

        </div>
        <div className="row pt-3 outline mob">
